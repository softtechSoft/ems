...
('A8','給料明細' ,"<a><span class='iconfont icon'>&#xe60c;</span>給料明細</a>",'0','/salarydetails','0' ,'0',date_format(now(),'%Y%m%d') ,null),
('A9','パスワード変更' ,"<a><span class='iconfont icon'>&#xe696;</span>パスワード変更</a>",'2','/passwd','99' ,'0',date_format(now(),'%Y%m%d') ,null);
