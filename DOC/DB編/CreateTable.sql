...
contributionRate float(6,5) not null comment'厚生子育拠出金率',
status int not null comment'利用ステータス',
insertDate varchar(8) not null comment'作成日',
updateDate varchar(8) not null comment'更新日'
) comment '厚生保険料マスタ'
...
year varchar(8) not null comment'対象年度',
laborBurdenRate float(6,5) not null comment'雇用保険労働者負担料率‰',
employerBurdenRate float(6,5) not null comment'雇用保険事業主負担料率‰',
employmentInsuranceRate float(6,5) not null comment'雇用保険料率‰',
industrialAccidentInsuranceRate float(6,5) not null comment'労災保険料率(全額事業主)‰',
laborInsuranceRate float(6,5) not null comment'労働保険料率‰',
contributionRate float(6,5) not null comment'一般拠出金料率(全額事業主)‰',
status int not null comment'利用ステータス',
insertDate varchar(8) not null comment'作成日',
updateDate varchar(8) not null comment'更新日'
) comment '雇用保険率テーブル'
